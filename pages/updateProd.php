            ...
            <div class="col-lg-12">
              <div class="card card-login mx-auto" style="width: 100%; margin-top: 100px;">
                <div class="card-header text-center">
                  <h3 class="text-primary text-center">Atualizar produto</h3>
                </div>
                <div class="card-body">
                  <form method="POST" action="#">
                    <div class="row">
                      ...
                      <div class="form-group col-3">
                        ...
                        <select class="custom-select" id="sit" name="sit" required>
                          <option selected disabled value="">Selecione a situação</option>
                    ...
                    <div class="row">
                      <div class="form-group col-3">
                        ...
                        <select class="custom-select" id="cat" required>
                    ...
                    <hr />
                    <button type="submit" class="btn btn-primary float-right"><span style="color: #fff;">Atualizar</span></button>
                  </form>
                </div>
              </div>
            </div>
