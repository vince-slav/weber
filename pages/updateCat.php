            ...
            <div class="col-lg-12">
              <div class="card card-login mx-auto" style="width: 100%; margin-top: 100px;">
                <div class="card-header text-center">
                  <h3 class="text-primary text-center">Atualizar categoria</h3>
                </div>
                <div class="card-body">
                  <form method="POST" action="recUpdateCat.php">
                    <div class="row">
                      <div class="form-group col-6">
                        <label for="nome">Categoria</label>
                        <input type="text" class="form-control" name="nome" id="nome" value="<?php echo $_GET["id"]; ?>">
                      </div>
                    </div>
                    <div class="row">
